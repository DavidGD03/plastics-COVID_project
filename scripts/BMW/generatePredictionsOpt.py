...
def main():
    ...
    if sys.argv[2] == 'LSTM' or sys.argv[2]== '':
        ...
        # define model
        model = Sequential()
        model.add(LSTM(64, return_sequences=True,activation='tanh', input_shape=(n_input, n_features)))
        model.add(LSTM(128, return_sequences=True,recurrent_activation='sigmoid'))
        ...
        # define model
        model = Sequential()
        model.add(GRU(64, return_sequences=True,activation='tanh', input_shape=(n_input, n_features)))
        model.add(GRU(128, return_sequences=True,recurrent_activation='sigmoid'))
        model.add(GRU(256, return_sequences=True,recurrent_activation='sigmoid'))
        model.add(GRU(128, return_sequences=True,recurrent_activation='sigmoid'))
        model.add(GRU(64, return_sequences=True,recurrent_activation='sigmoid'))
        #model.add(Dense(1,activation='linear'))
